...
export enum AdminPermission {
  ...
  RISK_WORKFLOW_MANAGE = 'risk_workflow.manage',
  SUPPORT_360_VIEW = 'support_360.view',
  QUEUE_MANAGE = 'queue.manage',
  FEATURE_FLAGS_EDIT = 'feature_flags.edit',
  PROVIDER_HEALTH_VIEW = 'provider_health.view',
  ...
  SECURITY_AUDIT_RUN = 'security_audit.run',
...
export const ROLE_PERMISSIONS_MAP: Record<AdminRole, AdminPermission[]> = {
  ...
  [AdminRole.OPERATIONS_ADMIN]: [
    ...
    AdminPermission.OPERATIONS_CONTROL,
    AdminPermission.RISK_WORKFLOW_MANAGE,
    AdminPermission.SUPPORT_360_VIEW,
    AdminPermission.QUEUE_MANAGE,
    ...
    AdminPermission.COMPLIANCE_VIEW,
    AdminPermission.FORECAST_VIEW,
    AdminPermission.OBSERVABILITY_VIEW,
    AdminPermission.INTELLIGENCE_ADMIN,
    AdminPermission.READINESS_VIEW,
    AdminPermission.SECURITY_AUDIT_RUN,
    AdminPermission.RECONCILIATION_RUN,
    AdminPermission.DISASTER_RECOVERY_MANAGE,
    AdminPermission.READINESS_ADMIN,
  ],
